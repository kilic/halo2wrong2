use crate::circuitry::witness::{Composable, Term, Witness};
use ff::PrimeField;
...
pub trait SecondDegreeChip<F: PrimeField + Ord>:
    Chip<crate::circuitry::enforcement::SecondDegree<F>, F>
{
    ...
    fn zero_sum_second_degree(&mut self, terms: &[Term<F>], constant_to_add: F) {
        ...
        let composition = crate::circuitry::enforcement::SecondDegree::new(terms, constant_to_add);
