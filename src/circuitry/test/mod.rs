...
use crate::circuitry::chip::second_degree::SecondDegreeChip;
use crate::circuitry::chip::select::SelectChip;
use crate::circuitry::witness::Composable;
use crate::circuitry::witness::Term;
use crate::circuitry::{
    chip::Core,
    stack::Stack,
...
impl<F: PrimeField + Ord> Stack<F> {
    pub(crate) fn _assign_witness(&mut self, w: &Witness<F>) {
        let e = crate::circuitry::enforcement::FirstDegree::new(vec![w.add(), w.sub()], F::ZERO);
