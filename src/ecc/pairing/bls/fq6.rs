use super::{fq2::Fq2, BLSPairingChip};
...
impl<N: PrimeField> Fq6<N> {
    pub fn value(&self) -> Value<bls12381::Fq6> {
        self.c0
            .value()
            .zip(self.c1.value())
            .zip(self.c2.value())
            .map(|((c0, c1), c2)| bls12381::Fq6 { c0, c1, c2 })
    }
}
...
impl<N: PrimeField + Ord> BLSPairingChip<N> {
    ...
    // pub(crate) fn fq6_assign(&self, stack: &mut Stack<N>, e: Value<bls12381::Fq6>) -> Fq6<N> {
    //     Fq6 {
    ...
    // pub(crate) fn fq6_constant(&self, stack: &mut Stack<N>, e: bls12381::Fq6) -> Fq6<N> {
    //     Fq6 {
