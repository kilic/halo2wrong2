...
impl<F: PrimeField + Ord, const W: usize> GateLayout<F, Vec<crate::enforcement::Range<F>>>
    for VerticalGate<W>
{
    ...
    fn layout<L: Layouter<F>>(
        ...
        e: Vec<crate::enforcement::Range<F>>,
...
impl<F: PrimeField + Ord, const W: usize> GateLayout<F, Vec<crate::enforcement::RangeLimbs<F>>>
    for VerticalGate<W>
{
    type Output = Vec<usize>;
    ...
    fn layout<L: Layouter<F>>(
        &self,
        ly_ctx: &mut LayoutCtx<F, L>,
        e: Vec<crate::enforcement::RangeLimbs<F>>,
    ) -> Result<Vec<usize>, Error> {
        ...
        let mut compositions: BTreeMap<
            ...
            Vec<crate::enforcement::RangeLimbs<_>>,
        > = BTreeMap::new();
...
impl<F: PrimeField + Ord> GateLayout<F, Vec<crate::enforcement::FirstDegree<F>>>
    for VerticalGate<1>
{
    type Output = ();
    fn layout<L: Layouter<F>>(
        &self,
        ly_ctx: &mut LayoutCtx<F, L>,
        e: Vec<crate::enforcement::FirstDegree<F>>,
    ) -> Result<(), Error> {
        #[cfg(feature = "info")]
        {
